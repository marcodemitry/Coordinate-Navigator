...
function getTargetCoordinates(){
    ...
    if(coordType.value === "dms"){
        ...
        let nDeg = parseFloat(document.getElementById("nDeg").value) || 0;
        let nMin = parseFloat(document.getElementById("nMin").value) || 0;
        let nSec = parseFloat(document.getElementById("nSec").value) || 0;
        let nDec = parseFloat(document.getElementById("nDec").value) || 0;

        let eDeg = parseFloat(document.getElementById("eDeg").value) || 0;
        let eMin = parseFloat(document.getElementById("eMin").value) || 0;
        let eSec = parseFloat(document.getElementById("eSec").value) || 0;
        let eDec = parseFloat(document.getElementById("eDec").value) || 0;
